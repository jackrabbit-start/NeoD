...
export const HEART_PICKUP_MAX_ACTIVE = 4
export const HEART_PICKUP_INITIAL_DELAY_MS = 4_000
export const HEART_PICKUP_INTERVAL_MS = 9_000
export const HEART_PICKUP_RANDOM_JITTER_MS = 3_000
