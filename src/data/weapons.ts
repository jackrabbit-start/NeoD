...
export const WEAPON_DEFINITIONS: Record<WeaponId, WeaponDefinition> = {
  ...
  'arc-loom': {
    ...
    identityLabel: '연쇄 킥',
    identityHint: '탄을 쏘는 게 아니라 한 번 가볍게 되튕기는 경로를 태우는 무기라 적이 몰릴수록 공이 더 오래 살아남습니다.',
    range: 380,
    damage: 10,
    fireRateMs: 560,
    projectileSpeed: 460,
  ...
  'prism-cutter': {
    ...
    id: 'prism-cutter',
    name: '동네 주먹',
    description: '말로 해명하다 안 되면 몸이 먼저 나가는 짤 같은 연속기입니다. 기본은 두 번의 연속기에서 시작하고, 레벨이 오를수록 손맛이 길어집니다.',
    identityLabel: '근접 콤보',
    identityHint: '기본은 두 번의 연속기지만 레벨이 오를수록 콤보 길이가 늘어나고, 마지막 타격이 점점 더 묵직해집니다.',
    damage: 12,
    fireRateMs: 780,
    projectileSpeed: 0,
